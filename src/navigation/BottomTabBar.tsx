      ...
      <View style={styles.innerBar}>
        {state.routes.map((route, index) => {
          ...
          const onPress = () => {
            ...
            const prevented = (
              event as unknown as { defaultPrevented?: boolean }
            ).defaultPrevented;
...
const styles = StyleSheet.create({
  container: {
    ...
    backgroundColor: 'transparent', // ✅ make whole wrapper transparent
    borderWidth: 0, // ✅ remove outer border
    elevation: 0, // ✅ remove extra Android shadow
    shadowColor: 'transparent', // ✅ no outer white glow
    flexDirection: 'row',
    alignItems: 'center',
